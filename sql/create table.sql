...
CREATE TABLE IF NOT EXISTS `te_user_passwd` (
  `ID` varchar(32) NOT NULL COMMENT '工号',
  `PASSWORD` varchar(64) NOT NULL COMMENT '密码'
)ENGINE=InnoDB DEFAULT CHARSET=utf8;


ALTER TABLE `te_user_passwd` ADD PRIMARY KEY(`ID`);
INSERT INTO `te_user_passwd` (`ID`,`PASSWORD`)VALUES('04303','3584338w');
INSERT INTO `te_user_passwd` (`ID`,`PASSWORD`)VALUES('04302','xx');
